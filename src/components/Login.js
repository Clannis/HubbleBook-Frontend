                ...
                <div class="row h-100 justify-content-center align-self-center text-center">
                    <form className="col-6 my-auto" onSubmit={this.handleSubmit}>
                        ...
                        <div class="input-group" id="show_hide_password">
                            ...
                            <div onClick={this.handleClick} class="input-group-append" style={{cursor: "pointer"}}>
                                <span class="input-group-text" id="basic-addon2" ref={this.eye}>
                                    ...
                                    <svg width="1em" height="1em" viewBox="0 0 16 16" class={`bi bi-eye-slash-fill ${this.state.closedEye ? "d-block": "d-none"}`} fill="currentColor" xmlns="http://www.w3.org/2000/svg">
